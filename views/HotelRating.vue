      ...
      <div class="mt-6 space-y-8 ">
        ...
        <form action="#"  @submit.prevent="addSurvey"  class="space-y-8">
          ...
          <div>
            ...
            <div class="mt-1">
              <li v-for = "survey in surveys" :key="survey.Hotel">
                {{survey.Hotel}}
              </li>
              <input v-model="newHotel" id="Hotel" name="Hotel" type="text" autocomplete="Hotel" required="" class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" />
            </div>
          </div>
