    ...
    <div class="mx-auto w-full max-w-sm lg:w-96">
      <div class="mt-6 space-y-8 ">
        ...
        <form action="#"  @submit.prevent="submit"  class="space-y-8">
          ...
          <div class="space-y-1">
            <label for="comment" class="block text-sm font-medium text-gray-700">Describe Yourself</label>
            <div class="mt-1">
              <input v-model="comment" id="comment" name="comment" type="comment" autocomplete="describe-yourself" required="" class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm" />
            </div>
          </div>
...
const register = () => {
  ...
  updateProfile(auth.currentUser, {displayName: name.value, displayComment: comment.value}).then((user) => {
