  ...
  <div class="mt-6 bg-gray-200">
    <div class="mt-10">
        ...
        <div v-if="carSelection == null">
          ...
          bg-white rounded-lg shadow-xl h-50 mt-4 w-100 mx-2">
              <div class="p-3 rounded-md shadow-lg md:w-3/4">
                <div v-show="cars.length" class="mt-12"></div>
                ...
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="car.svg"
                     height='30'
                     class=" inset-0 w-90 h-80 w-full object-cover object-center" role="img"
              ...
              <div class="w-full py-4 px-5 text-gray-800 flex flex-col justify-between">
                ...
                <div class=" capitalize text-lg font-semibold text-gray-600">{{ car.car_name }} or Similar
                  {{ car.cls }}
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <div class="text-left text-md text-gray-600 font-semibold"> {{ location }}</div>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <div class="text-left text-lg le.ading-tight text-gray-600 font-semibold"> Bags: {{
                      car.max_bags
                    }}
                  </div>
                </div>
                <div class="flex items-center">
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="car.svg"
                       ...
                       viewBox="0 0 320 512">
                    <path fill="currentColor"
                          d="M208 48c0 26.5-21.5 48-48 48s-48-21.5-48-48s21.5-48 48-48s48 21.5 48
                          48zM152 352V480c0 17.7-14.3 32-32 32s-32-14.3-32-32V256.9L59.4 304.5c-9.1 15.1-28.8 20-43.9 10.9s-20-28.8-10.9-43.9l58.3-97c17.4-28.9 48.6-46.6 82.3-46.6h29.7c33.7 0 64.9 17.7 82.3 46.6l58.3 97c9.1 15.1 4.2 34.8-10.9 43.9s-34.8 4.2-43.9-10.9L232 256.9V480c0 17.7-14.3 32-32 32s-32-14.3-32-32V352H152z"/>
                  </svg>
                  <div class="text-left text-lg text-gray-600 font-semibold"> Seats: {{ car.max_seats }}</div>
                </div>
                <div class="text-right text-xl leading-tight text-gray-600 font-semibold"> Total Price of Rental:
                  ${{ (car.min_price) }}
                </div>
                <a :href="car.dplnk" target="_blank">
                  <button type="button"
                          class="block w-1/5 py-2 p-4 rounded-md border border-transparent bg-indigo-900  text-sm  font-medium text-white shadow-sm hover:bg-indigo-700"
                          @click.prevent=" DetailsRental(car)"> Details
                  </button>
                </a>
                <div class="mt-12">
                </div>
      ...
      <div class=" w-10 lg:w-4/5 mx-auto">
        ...
        <div v-if="carSelection !== null">
          ...
          bg-white rounded-lg shadow-xl h-50 mt-4 w-100 mx-2">
              ...
              <div class="w-full py-4 px-5 text-gray-800 flex flex-col justify-between">
                ...
                <div class=" capitalize text-lg font-semi-bold text-gray-600">{{ car.car_name }} or Similar</div>
                <div class="flex items-center">
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="image2vector.svg"
                       class="h-3 w-3 text-blue-500 fill-current mr-1" role="img" xmlns="http://www.w3.org/2000/svg"
                       viewBox="0 0 384 512">
                  ...
                  <div class="text-left text-md text-gray-600 font-semi-bold"> {{ car.pu }}</div>
                </div>
                ...
                <div class="flex items-center">
                  ...
                  <div class="capitalize text-left text-md text-gray-600 font-semibold"> Transmission:
                    {{ carSelection.trans }}
                  </div>
                </div>
                ...
                <div class="text-right text-xl leading-tight text-gray-600 font-semibold"> Total cost of Vehicle:
                  ${{ (car.price).toFixed(2) }}
                </div>
        ...
        <div v-show="cars.length" class="mt-12">
        </div>
      </div>
      <div class="container w-90 lg:w-4/5 mx-auto flex flex-col">
